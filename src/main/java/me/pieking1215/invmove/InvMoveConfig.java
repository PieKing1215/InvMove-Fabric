...
public class InvMoveConfig {
    ...
    public static Function<Boolean, Text> movement_yesNoText = b -> new LiteralText(b ? Formatting.GREEN + "Allow Movement" : Formatting.RED + "Disallow Movement");
    public static Function<Boolean, Text> background_yesNoText = b -> new LiteralText(b ? Formatting.GREEN + "Hide Background" : Formatting.RED + "Show Background");
    ...
    public static Screen registerClothConfig(Screen parent) {
        ...
        movementTypes.add(eb.startBooleanToggle(new TranslatableText("config.invmove.type.horse"),        getBoolSafe(UI_MOVEMENT.horseInventory, true)).setDefaultValue(true).setSaveConsumer(UI_MOVEMENT.horseInventory::set).setYesNoTextSupplier(movement_yesNoText).build());
...
//        movement.addEntry(movementTypesSeen.build());
        ...
        backgroundTypes.add(eb.startBooleanToggle(new TranslatableText("config.invmove.type.horse"),        !getBoolSafe(UI_BACKGROUND.horseInventory, false)).setDefaultValue(true).setSaveConsumer(b -> UI_BACKGROUND.horseInventory.set(!b)        ).setYesNoTextSupplier(background_yesNoText).build());
